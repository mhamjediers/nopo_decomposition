...
eststo kmatch
nopo decomp wage i.age i.edu, by(groups) atc kmkeepgen dxse(1)
eststo nopo_diff
nopo decomp wage i.age i.edu, by(groups) atc kmkeepgen dxse(2)
eststo nopo2_pom
nopo decomp wage i.age i.edu, by(groups) atc kmkeepgen dxse(3)
eststo nopo3_poi
bootstrap, reps(1000): nopo decomp wage i.age i.edu, by(groups)
eststo nopo_bs
