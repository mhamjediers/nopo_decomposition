...
{phang} Allows for the {cmd:bootstrap:} and {cmd:jackknife:} prefix for bootstrapped standard errors (see {help nopo##desc:Description} for a note on standard errors).{p_end}
{phang} See {help nop_postestimation:{bf:nopo postestimation}} for three available features after estimation ({cmd:nopo summarize}, {cmd:nopo gapoverdist}, {cmd:nopo dadb}).{p_end}
{p2colreset}
