...
{synopt :{cmdab:kmpass:thru(}{it:string}{cmdab:)}}Returns of interal kmatch are added to returns of {cmd:nopo decomp}{p_end}{...}
...
{phang} Allows for the {cmd:bootstrap:} prefix for bootstrapped standard errors (see {help nopo##desc:Description} for a note on standard errors).{p_end}
{phang} See {help nopo##postest:{bf:nopo postest}} for three available features after estimation ({cmd:nopo summarize}, {cmd:nopo gapoverdist}, {cmd:nopo dadb}).{p_end}
{p2colreset}
